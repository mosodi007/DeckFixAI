        ...
        <div className="p-6 space-y-6">
            ...
            <div className="border rounded-xl p-6">
              ...
              <div className="space-y-3">
                {fix.visualRecommendations.map((rec, idx) => (
                  ...
                  >
                    <div className="flex-shrink-0 w-8 h-8 bg-black-100 rounded-lg flex items-center justify-center">
          ...
          <div className="flex gap-3 pt-4 border-t border-slate-200">
            <button
              ...
              disabled={isApplying}
              className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 text-white rounded-xl font-bold transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isApplying ? (
                <>
