  ...
  return (
    <div className="max-w-7xl mx-auto px-4 pb-8 sm:px-6 lg:px-8">
      ...
      <button
        ...
        className="fixed bottom-8 right-12 bg-[#000] hover:bg-slate-800 text-white pl-6 pr-7 py-4 rounded-full shadow-2xl flex items-center gap-3 font-semibold transition-all hover:scale-105 hover:shadow-3xl z-50 group"
      >
