...
export function AnalysisView({ data }: AnalysisViewProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
      <div className="bg-white/50 backdrop-blur-xl rounded-2xl shadow-xl border border-white/60 p-8 mb-8">
        <div className="flex items-start justify-between mb-6">
          ...
          <div className="flex gap-3">
            <button className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-md border-2 border-slate-300 text-slate-700 font-medium rounded-lg hover:border-slate-400 hover:bg-white/80 transition-all">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white/40 backdrop-blur-md rounded-xl p-6 border border-white/60">
        ...
        <div className="flex gap-3">
          <button className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-slate-700 to-slate-900 text-white font-semibold rounded-lg hover:from-slate-800 hover:to-black transition-all shadow-lg hover:shadow-xl">
            <Wand2 className="w-5 h-5" />
            Fix Issues Automatically
          </button>
          <button className="flex-1 inline-flex items-center justify-center gap-2 px-6 py-3 bg-white/60 backdrop-blur-md border-2 border-slate-300 text-slate-700 font-semibold rounded-lg hover:border-slate-400 hover:bg-white/80 transition-all">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        <div className="bg-white/50 backdrop-blur-xl rounded-xl shadow-lg border border-white/60 p-6">
        ...
        <div className="bg-white/50 backdrop-blur-xl rounded-xl shadow-lg border border-white/60 p-6">
          ...
          <div className="mt-4 p-4 bg-white/40 backdrop-blur-md rounded-lg border border-white/60">
        ...
        <div className="bg-white/50 backdrop-blur-xl rounded-xl shadow-lg border border-white/60 p-6">
          ...
          <ul className="space-y-3">
            {data.issues.map((issue: string, index: number) => (
              <li key={index} className="flex items-start gap-3 p-3 bg-white/40 backdrop-blur-md rounded-lg border border-orange-200">
